...
const CastCrewCard = ({ person }) =>
  <Card>
    <CardHeader className="text-center p-2">
      <CardTitle>
        <Link target='_blnk' href={`/peoples/${person.slug}`} className='flex flex-col text-center gap-2'>
          <Image src={getImageURL("persons", person.image)} height={120} width={120} alt={`${person.as_role} ${person.full_name}`} className='rounded-full aspect-[1/1] object-cover' />
